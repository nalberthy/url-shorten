...
- **Postman Collection**: [Collection pronta para teste direto](https://github.com/nalberthy/url-shorten/blob/feat/collections/collection/V2%20-%20URL%20Shorten.json)
